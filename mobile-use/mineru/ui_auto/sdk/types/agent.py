...
from mineru.ui_auto.sdk.types.task import AgentProfile, TaskRequestCommon
...
class AgentConfig(BaseModel):
    ...
    gui_owl_enabled: bool = False
    perception_mode: str = "classic"  # "classic" or "enhanced"
    exploration_mode: bool = False  # When True, exploration optimizations and safety guards are active
    lessons_dir: str | None = None  # Path to lessons directory for lesson-learned memory
