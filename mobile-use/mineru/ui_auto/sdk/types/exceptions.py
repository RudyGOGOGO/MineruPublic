    ...
    def __init__(self, executable_name: EXECUTABLES):
        ...
        if executable_name == "cli_tools":
            message = (
                ...
                "At least one of them is required to run ui-auto "
...
class AgentInvalidApiKeyError(AgentTaskRequestError):
    ...
    def __init__(self):
        super().__init__(
            "Minitap API key is incorrect. Visit https://platform.ui-auto.ai/api-keys "
            "to get your API key."
        )
...
class PlatformServiceUninitializedError(MobileUseError):
    ...
    def __init__(self):
        super().__init__(
            ...
            "To use Minitap platform service, visit https://platform.ui-auto.ai.",
        )
