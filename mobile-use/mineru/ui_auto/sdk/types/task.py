...
from mineru.ui_auto.config import LLMConfig, get_default_llm_config
from mineru.ui_auto.constants import RECURSION_LIMIT
from mineru.ui_auto.context import DeviceContext
from mineru.ui_auto.sdk.types.platform import TaskRunResponse, TaskRunStatus
from mineru.ui_auto.sdk.utils import load_llm_config_override


class AgentProfile(BaseModel):
    """
    Represents a ui-auto agent profile.
...
class TaskRequestBase(BaseModel):
    ...
    trace_path: Path = Path("ui-auto-traces")
...
class PlatformTaskRequest[TOutput](TaskRequestBase):
    ...
    trace_path: Path = Path(tempfile.gettempdir()) / "ui-auto-traces"
