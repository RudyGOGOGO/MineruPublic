...
from mineru.ui_auto.clients.ios_client_config import BrowserStackClientConfig, IosClientConfig
from mineru.ui_auto.config import get_default_llm_config, get_default_mineru_llm_config
from mineru.ui_auto.context import DevicePlatform
...
from mineru.ui_auto.sdk.types.task import TaskRequestCommon
...
class AgentConfigBuilder:
    ...
    def __init__(self):
        ...
        self._gui_owl_enabled: bool = False
        self._perception_mode: str = "classic"
        self._exploration_mode: bool = False
        self._lessons_dir: str | None = None
    ...
    def add_profile(self, profile: AgentProfile, validate: bool = True) -> "AgentConfigBuilder":
        """
        Add an agent profile to the ui-auto agent.
    ...
    def add_profiles(
        ...
        """
        Add multiple agent profiles to the ui-auto agent.
    ...
    def for_device(
        ...
        """
        Configure the ui-auto agent for a specific device.
    ...
    def for_cloud_mobile(self, cloud_mobile_id_or_ref: str) -> "AgentConfigBuilder":
        """
        Configure the ui-auto agent to use a cloud mobile.
    ...
    def for_browserstack(self, config: BrowserStackClientConfig) -> "AgentConfigBuilder":
        """
        Configure the ui-auto agent to use BrowserStack cloud devices.
    ...
    def for_limrun(
        ...
        *,
        ...
        Args:
            ...
            base_url: Base URL for Limrun API. Defaults to https://platform.mineru.ai.
    ...
    def with_gui_owl(self) -> "AgentConfigBuilder":
        """Enable GUI Owl VLM for vision-based element finding.

        When enabled, the cortex agent will use the find_element_by_vision tool
        to visually locate UI elements via the local GUI Owl model server.

        Returns:
            Self for method chaining
        """
        self._gui_owl_enabled = True
        return self

    def with_lessons_dir(self, path: str) -> "AgentConfigBuilder":
        """Enable lesson-learned memory with the given directory path.

        Returns:
            Self for method chaining
        """
        self._lessons_dir = path
        return self

    def with_exploration_mode(self) -> "AgentConfigBuilder":
        """Enable exploration mode (trimmed hierarchy, no screenshot, safety guards).
    ...
    def with_enhanced_perception(self) -> "AgentConfigBuilder":
        """
        Enable enhanced perception mode (UIAutomator + OCR + SoM overlay).

        Returns:
            Self for method chaining
        """
        self._perception_mode = "enhanced"
        return self

    def build(self, validate_profiles: bool = True) -> AgentConfig:
        """
        Build the ui-auto AgentConfig object.
        ...
        if isinstance(self._default_profile, str):
            ...
            llm_config = (
                get_default_mineru_llm_config(validate=validate_profiles)
        ...
        return AgentConfig(
            ...
            gui_owl_enabled=self._gui_owl_enabled,
