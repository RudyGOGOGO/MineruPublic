...
from mineru.ui_auto.sdk.types.agent import AgentProfile
from mineru.ui_auto.sdk.types.task import TaskRequest, TaskRequestCommon
...
class TaskRequestCommonBuilder(BaseModel):
    ...
    def __init__(self):
        ...
        self._trace_path = Path("ui-auto-traces")
