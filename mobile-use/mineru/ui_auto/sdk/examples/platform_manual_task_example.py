...
This example demonstrates how to use the ui-auto SDK with manual task creation:
...
Run:
- python src/ui_auto/sdk/examples/platform_manual_task_example.py
"""

import asyncio

from mineru.ui_auto.sdk import Agent
from mineru.ui_auto.sdk.types import ManualTaskConfig, PlatformTaskRequest
...
async def main() -> None:
    ...
    Visit https://platform.ui-auto.ai to get your API key.
