"""Telemetry service for ui-auto SDK using PostHog."""
...
EVENT_PREFIX = "ui_auto_"

TELEMETRY_CONFIG_DIR = Path.home() / ".mineru"
...
class TelemetryService:
    """PostHog telemetry service for ui-auto SDK."""
    ...
    def _get_sdk_version(self) -> str:
        """Get the ui-auto SDK version."""
        try:
            from importlib.metadata import version

            return version("mineru-ui-auto")
        except Exception:
            return "unknown"
