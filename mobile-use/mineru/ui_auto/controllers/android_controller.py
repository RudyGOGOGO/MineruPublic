...
from mineru.ui_auto.utils.video import (
...
class AndroidDeviceController(MobileDeviceController):
    ...
    async def _android_auto_restart_loop(
        ...
        while total_elapsed < max_duration_seconds:
            ...
            temp_dir = tempfile.mkdtemp(prefix="ui_auto_video_segment_")
    ...
    async def stop_video_recording(self) -> VideoRecordingResult:
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="ui_auto_video_")
            ...
            output_dir = tempfile.mkdtemp(prefix="ui_auto_video_final_")
