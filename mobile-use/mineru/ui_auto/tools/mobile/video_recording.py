...
from mineru.ui_auto.controllers.controller_factory import get_controller
...
from mineru.ui_auto.utils.video import DEFAULT_MAX_DURATION_SECONDS
...
def get_start_video_recording_tool(ctx: MobileUseContext) -> BaseTool:
    ...
    async def start_video_recording(
        ...
        if platform in (DevicePlatform.ANDROID, DevicePlatform.IOS):
            ...
            from mineru.ui_auto.utils.video import VideoRecordingResult
...
def get_stop_video_recording_tool(ctx: MobileUseContext) -> BaseTool:
    from mineru.ui_auto.agents.video_analyzer.video_analyzer import analyze_video
