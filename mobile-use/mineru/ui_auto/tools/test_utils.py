...
sys.modules["mineru.ui_auto.graph.state"] = Mock()

from mineru.ui_auto.context import DeviceContext, DevicePlatform, MobileUseContext  # noqa: E402
from mineru.ui_auto.tools.types import Target  # noqa: E402
from mineru.ui_auto.tools.utils import (  # noqa: E402
    IdSelectorRequest,
    SelectorRequestWithCoordinates,
    focus_element_if_needed,
    move_cursor_to_end_if_bounds,
)
from mineru.ui_auto.utils.ui_hierarchy import ElementBounds  # noqa: E402
...
class TestMoveCursorToEndIfBounds:
    ...
    @patch("mineru.ui_auto.tools.utils.tap")
    @patch("mineru.ui_auto.tools.utils.find_element_by_resource_id")
    ...
    @patch("mineru.ui_auto.tools.utils.tap")
    @patch("mineru.ui_auto.tools.utils.find_element_by_text")
...
class TestFocusElementIfNeeded:
    ...
    @patch("mineru.ui_auto.tools.utils.tap")
    @patch("mineru.ui_auto.tools.utils.logger")
    @patch("mineru.ui_auto.tools.utils.find_element_by_resource_id")
    def test_focus_id_and_text_mismatch_fallback_to_text(
        ...
        with patch("mineru.ui_auto.tools.utils.find_element_by_text") as mock_find_text:
    ...
    def test_focus_all_locators_fail(self, mock_logger, mock_context):
        ...
        mock_context.ui_adb_client.get_screen_data = Mock(return_value=mock_response)
        with (
            patch("mineru.ui_auto.tools.utils.find_element_by_resource_id") as mock_find_id,
            patch("mineru.ui_auto.tools.utils.find_element_by_text") as mock_find_text,
        ):
