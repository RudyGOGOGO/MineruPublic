...
from mineru.ui_auto.controllers.types import (
...
from mineru.ui_auto.utils.ui_hierarchy import (
    ElementBounds,
    Point,
...
def has_valid_selectors(target: Target) -> bool:
    ...
    has_element_id = target.element_id is not None
    ...
    return has_element_id or has_coordinates or has_resource_id or has_text
