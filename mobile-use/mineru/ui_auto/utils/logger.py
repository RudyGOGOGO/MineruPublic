...
def log_debug(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).debug(message)


def log_info(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).info(message)


def log_success(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).success(message)


def log_warning(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).warning(message)


def log_error(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).error(message)


def log_critical(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).critical(message)


def log_header(message: str, logger_name: str = "ui-auto"):
    get_logger(logger_name).header(message)


def get_server_logger() -> MobileUseLogger:
    return get_logger(
        name="ui-auto.servers",
        console_level="INFO",
        file_level="DEBUG",
    )
