...
from mineru.ui_auto.agents.outputter.outputter import outputter  # noqa: E402
from mineru.ui_auto.config import LLM, OutputConfig  # noqa: E402
from mineru.ui_auto.context import MobileUseContext  # noqa: E402
from mineru.ui_auto.utils.logger import get_logger  # noqa: E402
...
@patch("mineru.ui_auto.agents.outputter.outputter.get_llm")
@pytest.mark.asyncio
