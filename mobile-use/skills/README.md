...
Agent skills for AI coding assistants to help users set up and use the ui-auto SDK.

## Installation

```bash
npx add-skill mineru-ai/ui-auto
```
...
**Triggers:** "set up mobile automation", "configure ui-auto SDK", "connect iOS device", "connect Android device"
...
"I want to configure the ui-auto SDK"
