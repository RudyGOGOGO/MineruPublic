---
name: ui-auto-setup
description: Interactive setup wizard for Minitap ui-auto SDK. USE WHEN user wants to set up mobile automation, configure ui-auto SDK, connect iOS or Android devices, or create a new mobile testing project.
---

# Mobile-Use SDK Setup Wizard

Interactive guide for setting up the Minitap ui-auto SDK with support for iOS and Android devices, Platform and Local modes.

## When to Apply

This skill activates when users want to:
- Set up mobile automation for an app
- Configure the Minitap ui-auto SDK
...
# Add SDK
uv add mineru-ui-auto python-dotenv
```

### Phase 5: Configure Credentials

**For Platform Mode:**
1. Direct user to https://platform.mineru.ai to create account
...
from dotenv import load_dotenv
from mineru.ui_auto.sdk import Agent
from mineru.ui_auto.sdk.types import AgentProfile
...
# Test SDK import
uv run python -c "from mineru.ui_auto.sdk import Agent; print('SDK OK')"
```
...
→ Create: Project with uv init
→ Configure: .env with MINITAP_API_KEY
→ Guide: Create Virtual Mobile on platform.mineru.ai
