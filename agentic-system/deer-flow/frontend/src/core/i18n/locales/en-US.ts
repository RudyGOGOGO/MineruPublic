...
export const enUS: Translations = {
  ...
  inputBox: {
    ...
    sandbox: "Sandbox",
    sandboxLocal: "Local",
    sandboxLocalDescription:
      "Execute commands directly on the host machine, no isolation",
    sandboxContainer: "Container",
    sandboxContainerDescription:
      "Execute commands in an isolated container for safety",
